...
function calculateSalaryFrom(fullSalary) {
  ...
  let discountINSSPerc = round((discountINSS / fullSalary) * 100);
  let discountIRPFPerc = round((discountIRPF / fullSalary) * 100);
  let netSalaryPerc = round((netSalary / fullSalary) * 100);
